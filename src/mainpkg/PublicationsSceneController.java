...
public class PublicationsSceneController implements Initializable {

    @FXML
    private TextArea publicationTextArea;
    @FXML
    private TextField publicationIDTextField;
    ...
    private void LoadButtonOnClick(ActionEvent event) {
        Journalist.viewResearchPublication(publicationTextArea);
    }

    @FXML
    private void viewPDFButtonOnClick(ActionEvent event) {
        ResearchPaper rp = Journalist.getResearchPaper(Integer.parseInt(publicationIDTextField.getText()));
        ...
        try{
            ...
            if(f!=null){              
                ...
                String paraText1 
                        = "Title: " + rp.getPublicationTitle() + "\n\n"
                        + rp.getPublicationContent();
                Paragraph para1 = new Paragraph(paraText1);
                
                Text titleText = new Text("Transparency International: RESEARCH PAPER");
