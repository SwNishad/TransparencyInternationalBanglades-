 ...
 * @author Acer
 */
public class GPUserProfileSceneController implements Initializable {

    @FXML
    private Label gpNameLabel;
    @FXML
    private Label gpDOBLabel;
    @FXML
    private Label gpDOJLabel;
    @FXML
    private Label gpIDLabel;
    @FXML
    private Label gpEmailLabel;
    @FXML
    private Label gpPhoneLabel;
    @FXML
    ...
    @FXML
    private void printIDCardButtonOnClick(ActionEvent event) throws FileNotFoundException, IOException {
        ...
        try{
            ...
            if(f!=null){              
                ...
                String paraText1 
                        = "Membership ID: " + gpIDLabel.getText()
                        + "\nName: " + gpNameLabel.getText()
                        + "\nDate of Birth: " + gpDOBLabel.getText()
                        + "\nMember Since: " + gpDOJLabel.getText()
                        + "\nPhone: " + gpPhoneLabel.getText()
                        + "\nEmail: " + gpEmailLabel.getText();
                Paragraph para1 = new Paragraph(paraText1);
                para1.setTextAlignment(TextAlignment.CENTER);
                para1.setFontSize(15f);
                
                Text titleText = new Text("Transparency International Bangladesh: Active Citizen");
    ...
    @FXML
    private void verifyIdentityButtonOnClick(ActionEvent event) {
        int gpID = Integer.parseInt(membershipIDTextField.getText());
        String gpPassword = passwordPasswordField.getText();
        
        GeneralPublic.showUserProfile(gpID, gpPassword, gpIDLabel, gpNameLabel, gpDOBLabel, gpDOJLabel, gpEmailLabel, gpPhoneLabel);
    }
